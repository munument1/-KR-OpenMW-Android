...
2048x2048 / 8x11 / y=512 bitmap-font layout used by the project's existing
Morrowind CP949 FNT/TEX release and registers U+AC00..U+D7A3 MyGUI code points
at the corresponding atlas cells.
"""
...
KOREAN_BLOCK = r'''        // OPENMW_ANDROID_051_KOREAN_CP949_BITMAP
        // The Korean compatibility FNT keeps the normal 256 single-byte slots, but
        // stores the CP949 double-byte glyph atlas below y=512 in a 2048x2048 texture.
        // Classic Morrowind used slot 0xFF as a runtime DBCS template. OpenMW already
        // receives UTF-8/Unicode UI text, so expose those atlas cells as Unicode glyphs.
        {
